...
show_pages(
    [
        Page("Main.py", "Home", "🏠"),
        Page("sitepages/getstarted.py", "Getting Started", "🚀"),
        Page("sitepages/gettingrecords.py", "Getting Records", "📖"),
        Page("sitepages/insertingrecs.py", "Inserting Records", "✒️"),
        Page("sitepages/updatingrecs.py", "Updating Records", "📝"),
        Page("sitepages/delrecords.py", "Deleting Records", "🗑️"),
        Page("sitepages/searchrecs.py", "Searching Records", "🔍"),
        Page("sitepages/summarize.py", "Summarizing Data", "📊"),
        Page("sitepages/transactions.py", "Transactions", "🔄"),
        Page("sitepages/sql.py", "SQL Queries", "🐘"),
        Page("sitepages/askai.py", "Ask AI", "✈️"),
        Page("sitepages/files.py", "File Attachments", "📁"),
        Page("sitepages/images.py", "Images Transformations", "🖼️"),
        Page("sitepages/aggregations.py", "Aggregations", "📈"),
        Page("sitepages/vectorsearch.py", "Vector Search", "⚗️"),
        Page("sitepages/Helpers.py", "Helpers", "🛠️"),
        Page("sitepages/table_management.py", "Table Management", "📋"),
        Page("sitepages/errorhandling.py", "Error Handling", "🚨"),
